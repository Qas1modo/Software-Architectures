...
public static class ApiRoutes
{
    ...
    public static class CleanRoomRequest
    {
        public const string Get = "clean/requests";

        public const string Put = "clean/done";

        public const string Post = "clean/requests";
    }
