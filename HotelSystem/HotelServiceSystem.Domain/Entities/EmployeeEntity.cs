...
public sealed class EmployeeEntity : AggregateRoot, IAuditableEntity, ISoftDeletableEntity
{
    public EmployeeEntity(FirstName employeeFirstName, LastName employeeLastName, EmployeeTypeEnum employeeType) : base(Guid.NewGuid())
    {
    ...
    private EmployeeEntity() { } // Required by EF Core
