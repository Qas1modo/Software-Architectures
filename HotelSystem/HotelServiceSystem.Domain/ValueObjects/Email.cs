...
namespace HotelServiceSystem.Domain.ValueObjects
{
    ...
    public sealed class Email : ValueObject
    {
        ...
        public static Result<Email> Create(string email) =>
            Result.Create(email, DomainErrors.EmailErrors.NullOrEmpty)
                .Ensure(e => !string.IsNullOrWhiteSpace(e), DomainErrors.EmailErrors.NullOrEmpty)
                .Ensure(e => e.Length <= MaxLength, DomainErrors.EmailErrors.LongerThanAllowed)
                .Ensure(e => EmailFormatRegex.Value.IsMatch(e), DomainErrors.EmailErrors.InvalidFormat)
                .Map(e => new Email(e));
