...
namespace HotelServiceSystem.Domain.ValueObjects
{
    ...
    public sealed class LastName : ValueObject
    {
        ...
        public static Result<LastName> Create(string lastName) =>
            Result.Create(lastName, DomainErrors.LastNameErrors.NullOrEmpty)
                .Ensure(l => !string.IsNullOrWhiteSpace(l), DomainErrors.LastNameErrors.NullOrEmpty)
                .Ensure(l => l.Length <= MaxLength, DomainErrors.LastNameErrors.LongerThanAllowed)
